  ...
  <head>
    ...
    <script type="text/javascript">
          <%
                  ...
                  ResultSet rs = stmt.executeQuery(String.format("SELECT ROUND((Sum(SaleAmt) /SUM(YearPlanAmt))  * 100,0 )\n" +
              ...
              while (rs.next()){
                  ...
                  %>
      rMateChartH5.create("chart3", "body-content3chart", "", "100%", "100%");
      ...
      '<rMateChart backgroundColor="#FFFFFF" borderStyle="none">'
         ...
         */
        +'<Gauge minimum="0" maximum="100" minimumAngle="0" maximumAngle="360" innerRatio="0.85" fontSize="25" startAngle="-180" labelJsFunction="valueFunc" dataTipJsFunction="dataTipFunc" valueChangeFunction="changeFunction" labelYOffset="0" foregroundColors="[#619b8a]" backgroundColors="[#f5f5dc]" color="#333333" labelClickJsFunction="labelClickFunc">'
             +'<backgroundElements>'
                  +'<CanvasElement>'
