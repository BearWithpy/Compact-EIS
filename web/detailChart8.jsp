...
<head>
	...
	<script type="text/javascript">
		<%
                 ...
                 try {
                    ...
                    "password"
                     ...
                     jsonResult8 = jsonArray.toString();
		...
		const saleData2 = <%=jsonResult8%>;

		console.log(saleData2)
		rMateChartH5.create("chart8", "body3-content2chart", "", "100%", "100%");
