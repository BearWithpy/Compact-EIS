    ...
    <script>
           <jsp:include page="include/base.jsp"/>
               ...
               <%
                 ...
                 console.log(aj)
      rMateChartH5.create("fChart7", "footer-content10", "", "100%", "300px;");
      ...
      function rMateChartH5ChangeTheme(theme){
          document.getElementById("fChart7").setTheme(theme);
      }
      ...
      function minusbutton7(){
        console.log("축소버튼클릭!");
        if(count7%2==0){
          const element = document.getElementById('footer-content10');
