  ...
  <head>
    ...
    <script type="text/javascript">
          <%
                  ...
                  ResultSet rs = stmt.executeQuery("SELECT ROUND((Sum(SaleAmt) /SUM(YearPlanAmt))  * 100,0 )\n" +
              ...
              while (rs.next()){
                  ...
                  %>
      rMateChartH5.create("chart4", "body-content4chart", "", "100%", "100%");
