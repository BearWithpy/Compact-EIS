...
<head>
    ...
    <script type="text/javascript">
        ...
        rMateChartH5.create("chart11", "AccountChart5", "", "100%", "100%");
        ...
        var layoutStr3 =
            ...
            +'cylinderColor="[#cacfff,#cae9ff,#cae9ff]" cylinderAlpha="[1,1,1]" cylinderRatio="[0,100,255]" formatter="{cft}" '
        ...
        //게이지 데이터
        var chartData3 = [Math.floor(data3[1].Amt02 / data3[4].Amt02 * 100)];
        ...
        rMateChartH5.call("chart11", "setLayout", layoutStr3);
        rMateChartH5.call("chart11", "setData", chartData3);
        ...
        function changeValue(){
            ...
            document.getElementById("chart11").setData([parseInt(Math.random()*100)]);
        }
